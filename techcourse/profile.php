                 ...
                 <form action="profile.post.php" method="post">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control" value="<?=$dt_user['email']?>" id="contoh9">
                        </div>
                        <div class="col-md-6">
                            <label for="contoh10">Password</label>
                            <input type="password" name="password" class="form-control" value="<?=$dt_user['password']?>" id="contoh10">
                        </div>
                    </div>
